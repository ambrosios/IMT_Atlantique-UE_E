...
FICHIER_DONNEES = "recuit/donnees/tai11.txt" # Jeu de données avec nombre de jobs, nombre de machines, durées de chaque opération
...
NOMBRE_ITERATIONS = 220 # Nombre d'itérations par exécution de l'algorithme génétique

NOMBRE_EXECUTIONS = 30
